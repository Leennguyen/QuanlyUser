...
if ( !class_exists('True_News_Sidebar_Recent_Post_Widget') ) :
    ...
    class True_News_Sidebar_Recent_Post_Widget extends True_News_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            parent::__construct( 'true-news-popular-sidebar-layout', esc_html__('TN: Recent Post Widget', 'true-news'), $opts, array(), $fields );
        }
                            ...
                            <div class="twp-row twp-row-xs">
                                <div class="column column-four">
                                    <div class="article-image">
                                        <?php
                                        $feature_image = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'medium' );
                                        $feature_image = isset( $featured_image[0] ) ? $featured_image[0] : '';
                                        ?>

                                        <a href="<?php the_permalink(); ?>" class="data-bg data-bg-small" data-background="<?php echo esc_url( $feature_image ); ?>"></a>
