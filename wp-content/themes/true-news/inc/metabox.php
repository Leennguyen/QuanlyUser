...
function true_news_save_post_meta( $post_id ) {
    ...
    if( $post_type == 'post' ):
        ...
        $twp_enable_normal_comment_box_new = isset( $_POST['twp_enable_normal_comment_box'] ) ? sanitize_text_field( wp_unslash( $_POST['twp_enable_normal_comment_box'] ) ) : '';
        ...
        $twp_disable_ajax_load_next_post_new = isset( $_POST['twp_disable_ajax_load_next_post'] ) ? true_news_sanitize_meta_pagination( wp_unslash( $_POST['twp_disable_ajax_load_next_post'] ) ) : '';
    ...
    $new = isset( $_POST['true_news_post_sidebar_option'] ) ? true_news_sanitize_sidebar_option( wp_unslash( $_POST['true_news_post_sidebar_option'] ) ) : '';
