...
jQuery(function($){
    ...
    var ajaxurl = true_news_admin.ajax_url;
    var TrueNewsNonce = true_news_admin.ajax_nonce;
    // Dismiss notice
    $('.twp-custom-setup').click(function(){
        
        var data = {
            'action': 'true_news_notice_dismiss',
            '_wpnonce': TrueNewsNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-true-news-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-true-news-notice').addClass('twp-installing');

        var data = {
            'action': 'true_news_install_plugins',
            '_wpnonce': TrueNewsNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = true_news_admin.active
            var deactivate = true_news_admin.deactivate
