                                            ...
                                            <article class="news-article">
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
                                                        <span class="entry-image data-bg data-bg-big" data-background="<?php echo esc_url( $featured_image_1 ); ?>" ></span>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="verticle-slides <?php if ( !get_the_post_thumbnail() ){ echo 'twp-has-no-thumb'; } ?>">
                                            <article class="news-article">
                                                <div class="news-article-list direct-ltr">
                                                    <div class="entry-image">
                                                        <a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>">
                                                            <span class="entry-image data-bg data-bg-small" data-background="<?php echo esc_url( $featured_image_2 ); ?>" ></span>
                                                        </a>
                                                    </div>
                                                    <div class="entry-details">
                                                        <h3 class="entry-title entry-title-small">
